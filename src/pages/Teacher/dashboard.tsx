      ...
      <IonContent>
        ...
        <IonRow>
          ...
          <IonCol>
            ...
            <IonCardContent>
            <MDBTypography className="fw-bold ">Total Subject Handle</MDBTypography>
            <hr/>
          ...
          <IonCol>
            ...
            <IonCardContent>
           <MDBTypography className="fw-bold ">Student Passers</MDBTypography>
            <hr/>
            <MDBTypography className="fw-bold ">10,000</MDBTypography>
            </IonCardContent>
          ...
          <IonCol>
            ...
            <IonCardContent>
            <MDBTypography className="fw-bold ">Total Student at Risk</MDBTypography>
            <hr/>
            <MDBTypography className="fw-bold ">10,000</MDBTypography>
            </IonCardContent>
          ...
          <IonCol>
            ...
            <IonCardContent>
            <MDBTypography className="fw-bold ">Advisory Class</MDBTypography>
            <hr/>
            <MDBTypography className="fw-bold ">10,000</MDBTypography>
            </IonCardContent>
